...
var DonationList = React.createClass({
  render: function() {
    ...
    return <div className="donationList">{donationNodes}</div>;
  }
});
    ...
    return (
      <div className="payment">
        ...
        <input
          type="checkbox"
          checked={isChecked}
          onChange={this.handleClick.bind(this, optionsClass)}
          name="card"
        />
        Pay with card
        <br />
        <div id="Choices" className={this.state.displayClass}>
          Credit Card Information
          <br />
          <input type="text" placeholder="Card number" ref="card" />
          Card number
          <br />
          <input type="text" placeholder="CVV" ref="cvv" />
          CVV
          <br />
          <input type="text" placeholder="etc" ref="whatever" />
          Etc
          <br />
        </div>
        <InputError
    ...
    return (
      <div className="department">
        ...
        <div className={this.state.displayClass}>
          <input
            className="anyValue"
            value={this.props.value == "other" ? "" : this.props.value}
            type="text"
